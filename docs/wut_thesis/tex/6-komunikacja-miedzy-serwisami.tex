...
\begin{xltabular}{1\textwidth} { 
        ...
        | c
        | X | }
        \caption{Styki udostępniane przez Facilities Data Service} \label{tab:styki-facilities} \\
        \hline
    \textbf{Ścieżka} & 
...
\begin{xltabular}{1\textwidth} { 
        ...
        | c
        | X | }
        \caption{Styki udostępniane przez Policies Data Service} \label{tab:reguly-styki} \\
        \hline
    \textbf{Ścieżka} & 
