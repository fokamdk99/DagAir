...
using DagAir.Policies.Data.Migrations.Context;
using DagAir.Policies.Data.Sharding;
...
namespace DagAir.Policies.Data.Migrations
{
    public class Program
    {
        ...
        {
            const string appDatabaseName = "DagAir.Policies";
