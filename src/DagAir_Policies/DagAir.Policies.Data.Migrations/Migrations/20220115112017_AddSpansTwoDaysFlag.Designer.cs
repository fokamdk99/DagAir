...
namespace DagAir.Policies.Data.Migrations.Migrations
{
    ...
    [Migration("20220115112017_AddSpansTwoDaysFlag")]
    partial class AddSpansTwoDaysFlag
    {
            ...
            modelBuilder.Entity("DagAir.Policies.Data.AppEntities.RoomPolicy", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 1, 15, 14, 20, 16, 0, DateTimeKind.Unspecified),
                            EndHour = 12,
                            ExpectedConditionsId = 1L,
                            RepeatOn = "Monday, Thursday",
                            RoomId = 1L,
                            SpansTwoDays = false,
                            StartDate = new DateTime(2022, 1, 15, 12, 20, 16, 0, DateTimeKind.Unspecified),
                            StartHour = 10
                        },
                        new
                        {
                            ...
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = "dd8db40b-c091-4d12-a185-b2f71f369917",
                            EndDate = new DateTime(2023, 1, 15, 13, 20, 16, 0, DateTimeKind.Unspecified),
                            EndHour = 14,
                            ExpectedConditionsId = 2L,
                            RepeatOn = "Wednesday",
                            RoomId = 1L,
                            SpansTwoDays = false,
                            StartDate = new DateTime(2022, 1, 15, 9, 20, 16, 0, DateTimeKind.Unspecified),
                            StartHour = 12
                        },
                        new
                        {
