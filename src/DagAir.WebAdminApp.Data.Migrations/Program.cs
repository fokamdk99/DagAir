...
using DagAir.WebAdminApp.Data.Migrations.DesignTime;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Serilog;
using Serilog.Context;

namespace DagAir.WebAdminApp.Data.Migrations
{
    public class Program
    {
        ...
        private static async Task MigrateDbAsync(ConnectionString shardConnectionString, DesignTimeDbContextFactory factory)
        {
        ...
        {
            const string appDatabaseName = "DagAir.Identity";
            ...
            return MigrateDbAsync(new ConnectionString(appDatabaseName, connectionString), new DesignTimeDbContextFactory());
        }
    }
}