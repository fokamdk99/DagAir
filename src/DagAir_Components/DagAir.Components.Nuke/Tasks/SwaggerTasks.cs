...
{
    public static class SwaggerTasks
    {
        private static string SwaggerPath =>
            ToolPathResolver.GetPathExecutable("swagger");
        
        public static IReadOnlyCollection<Output> GenerateSwaggerDocs(
            string arguments,
        ...
        {
            var process = ProcessTasks.StartProcess(SwaggerPath,
