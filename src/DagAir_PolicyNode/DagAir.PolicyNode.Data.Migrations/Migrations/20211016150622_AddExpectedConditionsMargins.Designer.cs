...
namespace DagAir.PolicyNode.Data.Migrations.Migrations
{
    ...
    [Migration("20211016150622_AddExpectedConditionsMargins")]
    partial class AddExpectedConditionsMargins
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("DagAir.PolicyNode")
                .HasAnnotation("Relational:MaxIdentifierLength", 64)
                .HasAnnotation("ProductVersion", "5.0.10");

            modelBuilder.Entity("DagAir.PolicyNode.Data.AppEntities.ExpectedRoomConditions", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DagAir.PolicyNode.Data.AppEntities.RoomPolicy", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DagAir.PolicyNode.Data.AppEntities.RoomPolicyCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DagAir.PolicyNode.Data.AppEntities.RoomPolicy", b =>
                {
                    b.HasOne("DagAir.PolicyNode.Data.AppEntities.RoomPolicyCategory", "Category")
                    ...
                    b.HasOne("DagAir.PolicyNode.Data.AppEntities.ExpectedRoomConditions", "ExpectedConditions")
                        .WithOne("RoomPolicy")
                        .HasForeignKey("DagAir.PolicyNode.Data.AppEntities.RoomPolicy", "ExpectedConditionsId")
